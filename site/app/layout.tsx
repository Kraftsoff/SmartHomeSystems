...
const org = {
  ...
  /* logo и sameAs ждут клиента: файл логотипа и адреса профилей компании.
     Ставить сюда заглушку нельзя — машина цитирует разметку как факт. */
  ...
  return (
    <html lang="ru">
      <body>
        ...
        <StickyCta />
        <CookieBar />
        {/* Логотип и профили компании в разметке организации — то, по чему
            машина связывает сайт с сущностью в своей базе. Файла логотипа и
            адресов профилей у нас нет, а заглушка в разметке цитируется как
            факт, поэтому здесь пометка, а не выдумка. */}
        <p className="visually-hidden">
          <span className="prov">⚠️ заполнить: файл логотипа и адреса профилей компании (Яндекс Карты, соцсети) для разметки организации</span>
        </p>
