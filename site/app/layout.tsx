...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    /* Тёмная тема — фирменная, а не «ночной режим». Вся графика бренда:
       контроллеры, панели, датчики, линейная графика сцен — светящиеся
       предметы на чёрном. На белом фоне они выглядят чужими наклейками,
       и сайт читается пустым и скучным. Ставится атрибутом прямо в разметке,
       иначе страница отдаётся светлой и перекрашивается после гидратации —
       вспышкой в глаза. Переключатель на месте: кому нужен светлый, тот его
       выберет, и выбор запомнится. */
    <html lang="ru" className="nojs" data-mode="night">
