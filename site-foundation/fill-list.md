...
# Что заполнить — список из 86 пунктов
...
|---|---|
| время переключения уточнить по применяемому АВР | /answers/chto-prodolzhit-rabotat-v-dome-pri-otklyuchenii, разделы: /functions/electric/power-supply/ |
...
| заполнить: наш порядок обновления сданных объектов — платно или нет, удалённо или выездом, обязательно или по желанию | /answers/mozhno-li-obnovlyat-i-rasshiryat-sistemu-umnogo |
...
| заполнить: юридический адрес | компонент layout.tsx |
| заполнить: CRM и её оператор | /privacy |
| заполнить: email для обращений | /privacy |
| подтвердить или снять | /about |
| подтвердить модельный ряд, срок выпуска линейки и наличие складского запаса | разделы: /equipment/controllers/ |
| подтвердить перечень поддерживаемых линеек светильников | разделы: /functions/lighting/biodynamics/ |
...
| подтвердить: делать ли отдельные страницы под отели и диспетчеризацию ЖК | /solutions |
...
| подтвердить: какие из этих линеек доступны к поставке в 2026 году и по каким появились ограничения | /equipment |
...
| подтвердить: собирает ли контроллер телеметрию и куда она уходит | /answers/chto-vidit-proizvoditel-v-moem-dome |
...
| порог уточняется | /pricing, /solutions/flat и ещё 4 |
| пороги уточняются | /pricing |
| пороги CO₂ и режимы привести к действующим нормам для жилых помещений | разделы: /functions/climate/ventilation/ |
| поставить наши доли по закрытым проектам: оборудование / монтаж / проектирование и программирование | /pricing |
| поставить наши сроки по стадиям в неделях: обследование, проект, поставка, прокладка, монтаж, пусконаладка — по закрытым объектам | /answers/skolko-vremeni-zanimaet-montazh-umnogo-doma |
| поставить наши тарифы: регламентное ТО в год, выезд вне регламента, обновление ПО контроллера | /answers/skolko-stoit-vladenie-obsluzhivanie-abonentka-rashodniki |
| поставить нашу разницу в цене против KNX на сопоставимом объекте — в процентах или в рублях | /answers/skolko-stoit-umnyy-dom-na-knx-po |
| поставить типовой размер щита в модулях и в сантиметрах — отдельно для квартиры и для дома | /answers/skolko-mesta-zaymet-schit-i-kuda-ego |
...
| состав и место установки согласовать с проектом пожарной безопасности объекта | разделы: /equipment/sensors/smoke/ |
...
| уточнить состав работ, требующих лицензии МЧС — п. 15 ч. 1 ст. 12 ФЗ-99 | /answers/chem-umnyy-dom-dlya-kommercheskogo-obekta-s, разделы: /functions/security/fire/ |
| уточнить, есть ли в составе работ пожарная сигнализация или СОУЭ | компонент layout.tsx |
